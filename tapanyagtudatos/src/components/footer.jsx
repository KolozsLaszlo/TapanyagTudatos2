        ...
        <div className="py-10 w-full px-4">
          <div className="grid gap-10 md:grid-cols-3 pb-10">
            <div className="space-y-6">
              ...
              <p className="leading-relaxed">Tápanyagtudatos: Az egészséges táplálkozás szakértői oldalán fedezheti fel a kiegyensúlyozott étrend titkait. Kiváló receptek, hiteles információk és hasznos tippek várják Önt minden nap!</p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-center">
                <input type="text" className="w-2xs text-black bg-green-400 p-2 lg:p-3 lg:p-3-rounded-1-md focus:outline-none rounded-l-md" placeholder="Add meg az email címed" />
                <button type="submit" className="bg-green-700 px-4 py-2 lg:px-5 lg:py-3 rounded-r-md hover:opacity-90 hover:cursor-pointer text-black">
